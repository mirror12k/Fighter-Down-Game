...
function CannonAsteroid(game, px, py, path) {
	...
	this.add_entity(new SmallCannon(game, offset.px, offset.py, [{
		timeout: 60,
		repeat: 100,
		angle: cannon_angle,
...
function UFOCarrier(game, px, py, path) {
	...
	for (var i = 0; i < 360 / 90; i++) {
		...
		var plate = new EnemyEntity(game, offset.px, offset.py, 48, 96, game.images.ufo_carrier_armor);
		plate.health = 500;
		plate.angle = angle;
		plate.collision_radius = 24;
...
function main () {
	...
	var assets = {
		images: {
			...
			ufo_carrier_body: "ufo_carrier_body.png",
			ufo_carrier_armor: "ufo_carrier_armor.png",
			...
			bright_blue_square_bullet: "bright_blue_square_bullet.png",
